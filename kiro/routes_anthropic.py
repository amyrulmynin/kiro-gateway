...
from kiro.usage_tracker import track_request
                    ...
                    if request_data.stream:
                        ...
                        async def stream_wrapper():
                            ...
                            try:
                                ...
                                _latency = (time.time() - _start_time) * 1000
                                _status = 500 if streaming_error else 200
                                asyncio.ensure_future(track_request(
                                    model=request_data.model, endpoint="anthropic",
                                    latency_ms=_latency, status_code=_status,
                                    error_message=str(streaming_error) if streaming_error else None,
